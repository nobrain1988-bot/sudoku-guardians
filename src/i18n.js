...
const en = {
  ...
  ui: {
    ...
    outOfChancesBody: 'Watch a short ad and you get three more. Or keep solving — it just will not count toward your score.',
...
const ko = {
  ...
  ui: {
    ...
    outOfChancesBody: '짧은 광고를 보시면 기회 3번을 다시 드립니다. 그냥 계속 푸셔도 됩니다 — 점수에만 안 들어갑니다.',
...
const ja = {
  ...
  ui: {
    ...
    outOfChancesBody: '短い広告を見ると3回もらえます。そのまま解き続けてもかまいません — 点数に入らないだけです。',
