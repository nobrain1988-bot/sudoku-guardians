...
const en = {
  ...
  ui: {
    ...
    start: 'Start',
    outOfChances: 'Out of chances',
    outOfChancesBody: 'Watch a short ad and you get one more chance. Or keep solving — it just will not count toward your score.',
    watchToContinue: 'Watch and keep going',
    continuePractice: 'Keep solving for practice',
    adLabel: 'Ad',
    practiceRun: 'Practice',
    practiceNote: 'Finished as practice — no score or XP this time.',
...
const ko = {
  ...
  ui: {
    ...
    techniques: '배운 기술',
    start: '시작하기',
    outOfChances: '기회를 다 쓰셨어요',
    outOfChancesBody: '짧은 광고를 보시면 기회를 한 번 더 드립니다. 그냥 계속 푸셔도 됩니다 — 점수에만 안 들어갑니다.',
    watchToContinue: '광고 보고 이어하기',
    continuePractice: '연습으로 계속 풀기',
    adLabel: '광고',
    practiceRun: '연습',
    practiceNote: '연습으로 마치셨습니다 — 이번 판은 점수와 XP가 없습니다.',
...
const ja = {
  ...
  ui: {
    ...
    techniques: '覚えた手筋',
    start: 'はじめる',
    outOfChances: 'チャンスを使い切りました',
    outOfChancesBody: '短い広告を見るとチャンスを1回もらえます。そのまま解き続けてもかまいません — 点数に入らないだけです。',
    watchToContinue: '広告を見て続ける',
    continuePractice: '練習として続ける',
    adLabel: '広告',
    practiceRun: '練習',
    practiceNote: '練習として終えました — 今回は点数もXPもありません。',
